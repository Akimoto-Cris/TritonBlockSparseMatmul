...
if __name__ == "__main__":
    ...
    b_mask = torch.randint(0, 2, (128//32, 128//32), device='cuda').to(torch.float16)
    mask_step = get_step_from_b_mask(b_mask)
    b_mask_up = torch.nn.functional.interpolate(b_mask[None, None, ...], scale_factor=32).squeeze().to(torch.int)
